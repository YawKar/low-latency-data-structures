...
- *(publish)* Git cliff now idempotent across runs

### ⚙️ Miscellaneous Tasks

- Bump up the version to v0.0.6 to check new release flow
## [0.0.5] - 2026-07-29
...
- Bump up the version to v0.0.5 to check new release flow
## [0.0.4] - 2026-07-27
